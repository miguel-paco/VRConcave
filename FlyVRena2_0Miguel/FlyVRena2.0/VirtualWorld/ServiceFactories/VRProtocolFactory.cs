...
namespace FlyVRena2._0.VirtualWorld.ServiceFactories
{
    public class VRProtocolFactory : ServiceFactory
    {
        ...
        [XmlElement("RecordStimulus")]
        public bool recordStimulus;
        [XmlElement("PathRecordingStimulus")]
        public string pathRecordingStimulus;

        [XmlElement("RecordPhotodiode")]
        public bool recordPhotodiode;
